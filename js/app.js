var board, boardPositions, carFreedom, carPadding, carPositions, colours, container, detectFreedom, drag, dragEnd, dragMove, dragStart, intersection, moves, occupiedPositions, positionToX, positionToY, scalar, startMoment, startXY, svg, tilePadding, timer, updateTimer, _ref;
...
_ref = [[], 0], carFreedom = _ref[0], startXY = _ref[1];
...
d3.json('js/level1.json', function(error, json) {
  var car, carAttributes, cars, squareAttributes, squares, _i, _len, _ref1;
  if (error) {
    console.warn(error);
  }
